                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="footer-widget">
                                    ...
                                    <div class="media">
                                        <a class="pull-left" href="#"> <?= Html::img(Yii::getAlias('@web').'/img/demo/m2.jpg', ['style' => 'width:75px;height:75']) ?></a>
                                ...
                                <div class="footer-widget">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-sm-3 col-xs-6">
                                            <a href="#" class="thumbnail"><?= Html::img(Yii::getAlias('@web').'/img/demo/wf1.jpg', ['style' => 'width:75px;height:75','class'=>'img-responsive']) ?></a>
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-3 col-xs-6">
                                            <a href="#" class="thumbnail"><?= Html::img(Yii::getAlias('@web').'/img/demo/wf2.jpg', ['style' => 'width:75px;height:75','class'=>'img-responsive']) ?></a>
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-3 col-xs-6">
                                            <a href="#" class="thumbnail"><?= Html::img(Yii::getAlias('@web').'/img/demo/wf3.jpg', ['style' => 'width:75px;height:75','class'=>'img-responsive']) ?></a>
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-3 col-xs-6">
                                            <a href="#" class="thumbnail"><?= Html::img(Yii::getAlias('@web').'/img/demo/wf4.jpg', ['style' => 'width:75px;height:75','class'=>'img-responsive']) ?></a>
                                        </div>
                                    </div>
                                </div>
                            </div>

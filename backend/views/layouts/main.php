                                ...
                                <ul id="profileMenu" class="g-pos-abs g-left-0 g-width-100x--lg g-nowrap g-font-size-14 g-py-20 g-mt-17 rounded" aria-labelledby="profileMenuInvoker">
                                    ...
                                    <li class="mb-0">
                                        ...
                                        if (!Yii::$app->user->isGuest) {
                                            echo "<a class='media g-color-primary--hover g-py-5 g-px-20' data-method='post' href='" . Url::to(['site/logout']) . "'>";
                                            echo "<span class='d-flex align-self-center g-mr-12'>";
                                            echo "<i class='hs-admin-shift-right'></i>";
                                            echo "</span>";
                                            echo Html::beginForm(['/site/logout'], 'post')
                                            . Html::submitButton('Logout (' . Yii::$app->user->identity->username . ')', ['class' => 'btn btn-warning'])
                                            . Html::endForm();
                                            echo "</a>";
                                        }
                                        ?>

                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-5 hidden-xs carousel-img-wrap">
                            <div class="carousel-img">
                                <?= Html::img('../../themes/ai/img/demo/pre.png', ['class' => 'img-responsive animated bounceInUp animation-delay-3']) ?>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-4 hidden-xs carousel-img-wrap">
                            <div class="carousel-img">
                                <?= Html::img('../../themes/ai/img/demo/pre2.png', ['class' => 'img-responsive animated bounceInUp animation-delay-3']) ?>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-5 col-sm-3 hidden-xs carousel-img-wrap">
                            <div class="carousel-img">
                                <?= Html::img('../../themes/ai/img/demo/pr3.png', ['class' => 'img-responsive animated bounceInUp animation-delay-3']) ?>
                            </div>
                        </div>
                    </div>
                </div>
